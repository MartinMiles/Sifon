...
namespace Sifon.Code.VersionSelector
{
    public static class Settings
    {
        internal static List<KernelHash> Hashes => new List<KernelHash>
        {
            ...
            new KernelHash { Version = "Sitecore 9.1.1", Original = "78a87ff66bd077fb9cea89f114a0c03c" },
            new KernelHash { Version = "Sitecore 9.2.0", Original = "22cf534c9cdf9df1ff605dcb78e5ee72" },
            new KernelHash { Version = "Sitecore 9.3.0", Original = "aaa7b64372163d4da14a1568f42bbd61" }
        };
    }
}